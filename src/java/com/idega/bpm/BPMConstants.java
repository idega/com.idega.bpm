...
public class BPMConstants {
	...
	public static final String PDF_OF_XFORMS_PATH_IN_REPOSITORY = CoreConstants.CONTENT_PATH + "/xforms/pdf/";
	public static final String TEMP_PDF_OF_XFORMS_PATH_IN_REPOSITORY = CoreConstants.PUBLIC_PATH + "/xforms/pdf/temp/";
